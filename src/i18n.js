const messages = {
  en: {
    ...
    updatePlaceholderTitle: 'Software updates are not available yet',
    updatePlaceholderMessage: 'The developer has not enabled software update or auto-update services yet.\nPlease download the latest package manually from the software download repository.',
    updateAvailableTitle: 'New version available',
    updateAvailableMessage: 'A newer ClipAnchor version is available.\nYou can update from the software download repository when you are ready.',
    updateAvailableDetail: 'If you skip the update, the update button will keep a small reminder dot so you can return to it later.',
    updateFailedTitle: 'Update was not completed',
    updateFailedMessage: 'ClipAnchor could not complete the background update check or update process.\nYou can retry later or download the latest package manually.',
    updateFailedDetail: 'Background failures stay silent while the main window is closed, then appear here the first time you open the interface.',
  ...
  zh: {
    ...
    clearLogsDone: '日志已清理。',
    checkUpdate: '检查更新',
    updatePlaceholderTitle: '暂未开放软件更新服务',
    updatePlaceholderMessage: '开发者暂未开放软件更新或自动更新服务。\n请手动到软件下载仓库中下载新版安装包或便携包。',
    updateAvailableTitle: '发现新版本',
    updateAvailableMessage: '检测到 ClipAnchor 有新版本可用。\n你可以在方便的时候到软件下载仓库获取新版安装包或便携包。',
    updateAvailableDetail: '如果暂不更新，检查更新按钮右上角会保留提示点，方便稍后处理。',
    updateFailedTitle: '更新未完成',
    updateFailedMessage: 'ClipAnchor 未能完成后台更新检查或更新流程。\n你可以稍后重试，或手动下载最新软件包。',
    updateFailedDetail: '后台失败不会在主界面关闭时打扰你，首次打开主界面时才会显示这条提示。',
